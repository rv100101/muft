...
const SignInPage = () => {
  return (
    <div className="grid h-[calc(100vh-57px)] md:h-[calc(100vh-90px)] grid-cols-1 lg:grid-cols-2 lg:gap-4 w-full lg:px-32 border-t">
      <Helmet>
        <title>Sign in</title>
      ...
      <div className="flex flex-col h-full w-full md:h-[calc(100vh-90px)] lg:items-center justify-center">
