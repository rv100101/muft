...
import { Skeleton } from "../ui/skeleton"; import useHomePageScrollPosition from "@/zustand/home/scrollPosition"; import { useEffect, useRef, useState } from "react";
import { useDebounce } from "@uidotdev/usehooks";

const Posts = ({ isLoading, memberList }: { isLoading: boolean, memberList: Member[] }) => {
  ...
  }} ref={containerRef} className="col-span-4 w-min overflow-y-auto no-scrollbar 2xl:w-1/2">
    {isLoading ? (
      <>
