...
const MemberList = ({
  ...
  return (
    <div
      ...
      ref={containerRef}
      className="no-scrollbar pt-8 py-4 flex flex-col items-center lg:p-8 px-0 md:w-full w-screen h-screen sm:w-full rounded-b-xl space-y-4 border-[#E0E0E0] dark:border-[#131d2d] overflow-y-scroll overflow-x-clip">
      {memberList.length > 0 ? (
