...
const ProfileHeader = () => {
  ...
  const selectedUserId = useHomepageViewStore((state) =>
      ...
      await Promise.all([
        axiosQuery.post(
          "https://muffinfunction.azurewebsites.net/api/SaveGender",
          {
            ...
            member: selectedUserId ? selectedUserId : user!.member_id,
          },
        ),
        ...
        axiosQuery.post(
          ...
          {
            ethnicity: basicInfoFormData.ethnicity,
            member: selectedUserId ? selectedUserId : user!.member_id,
          },
        ),
        ...
        axiosQuery.post(
          ...
          {
            language: basicInfoFormData.language,
            member: selectedUserId ? selectedUserId : user!.member_id,
          },
        ),
      ]);
    ...
    try {
      await Promise.all([
        axiosQuery.post(
          ...
          {
            education: WorkEduInfoFormData.education,
            member: selectedUserId ? selectedUserId : user!.member_id,
          },
        ),
        axiosQuery.post(
        ...
        axiosQuery.post(
          ...
          {
            income: WorkEduInfoFormData.income,
            member: selectedUserId ? selectedUserId : user!.member_id,
          },
        ),
      ]);
    ...
    try {
      await Promise.all([
        ...
        axiosQuery.post(
          ...
          {
            body_type: DetailsFormData.bodyType,
            member: selectedUserId ? selectedUserId : user!.member_id,
          },
        ),
