...
const BasicInformationForm = () => {
  ...
  return (
    <div className={cn("flex flex-col h-96 overflow-y-scroll no-scrollbar w-full space-y-4", !user?.profile_completed && 'h-full')}>
                  ...
                  return (
                    <FormItem>
                      ...
                      <Select
                        ...
                        defaultValue={field.value && field.value.length > 1
                          ? field.value[0]
                          : field.value}
                      >
                        <FormControl>
            ...
            <div className="flex flex-row space-x-2 hover:cursor-pointer">
              ...
              <div className="flex flex-col justify-start space-y-1">
                <p className="font-bold text-base text-primary">
                  {[
                    ...new Set(
                      data?.language.map((lang) => lang.language_name),
                    ),
                  ].join(", ") ?? "Add languages"}
                </p>
