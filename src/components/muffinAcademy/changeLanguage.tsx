      ...
      <div className="flex justify-between items-center h-max">
        <DialogTrigger className="flex">
          <Button
            ...
            className={cn(
              "hover:text-white/80 rounded-full h-10 text-sm border-[#DDDDDD] bg-white py-2 w-max dark:bg-[#1b1d1e] dark:hover:text-white bg-primary text-white hover:bg-[#ff599b]/90"
            )}
            onClick={() => setChangePreferredLanguage(true)}
          >
            <span
              className={cn("w-4", lang == "en" ? 'mr-1' : "mx-1")}>
              {
                lang !== 'en' ?
                  <img
