...
import { usePreferredLanguageStore } from "../../src/zustand/auth/preferred_language";
import { useUserStore } from "../../src/zustand/auth/user";
import profileAboutContentStore from "../../src/zustand/profile/profileAboutStore";
...
const PreferredLanguageDialog = ({
  ...
  // Ensure state is consistent after hydration
  ...
  return (
    isHydrated && (
      <Dialog
        open={
          (preferred == null && pathname !== "/places/") ||
          ...
          <div className="flex justify-between items-center h-max">
            ...
            <DialogTrigger className="flex">
              <Button
                ...
                className={cn(
                  "hover:text-[#727272] rounded-full text-[#727272] h-10 text-sm border-[#DDDDDD] bg-white py-2 w-max dark:bg-[#1b1d1e] dark:hover:text-white",
                  isLandingPage &&
                    "bg-primary text-white hover:bg-[#ff599b]/90 hover:text-white "
                )}
              ...
              >
                <span
                  className={cn(
                    "w-4",
                    i18n.language == "en" && isLandingPage ? "mr-1" : "mx-1"
                  )}
                >
                  {isLandingPage && triggerTitle && i18n.language == "en" ? (
                    <img
        ...
        >
          ...
          <div className="flex flex-col justify-start m-0 w-full">
            <div
              ...
              className={cn(
                "hover:cursor-pointer flex space-x-2 items-center border-b p-4",
                i18n.language == "ar" ? "space-x-reverse" : "bg-[#F6F6F6]"
              )}
            >
              <img
            ...
            <div
              ...
              className={cn(
                "flex hover:cursor-pointer space-x-2 items-center border-b p-4",
                i18n.language == "ar" && "space-x-reverse bg-[#F6F6F6]"
              )}
            >
              <img
